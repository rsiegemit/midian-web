...
PTH
"$PREFIX/bin/pip" install --no-input -q -r "$REPO/requirements-frameworks/crewai.txt"
"$PREFIX/bin/python" -c "import requests; print('fw_crewai OK')"
