"""The value-ranked legend of the exploratory figures (figures/bars, figures/shortlist): entries ranked best first by the
value each one plots, laid out ROW-MAJOR -- best top left, then left to right, then the next row. matplotlib fills legend
