...
live
10^5 peer-halving cells. Read straight from each grid's rows.csv / rows.d (<= 1,500 rows per grid; never through
rte.analyze.load).
...
v6.halving_live.n100000.<regime>.seed<k>
Regimes follow RESULTS: beta0 (liar-free, one cell), beta<x>_random, beta<x>_cartel (low_skill_first); the cartel at
beta = 0.5 is 'cartel'."""
