...
| T4 | Probe builds: `RTE_CONCURRENCY` (default 64) = LLM requests in flight; raise to 256 for big new builds when the fleet has headroom. MIDIAN build = ~16.5 n b probes; only generations already cached are free (b = 3 is cached everywhere; new b needs new generations). | 10^5 b = 3 cold build 16.6 h; b = 10 at 10^5 ~ 11.5 M new generations (~2 days) | `rte/llm_client.py` |
