...
$PY cluster/archive/quarantine_fallback_rows.py > $RTE_DATA/logs/final_audit.log 2>&1
...
echo AUDIT_CLEAN
$PY scripts/analysis/paper_numbers.py && echo STEP_NUMBERS_OK
$PY scripts/analysis/doc_tables.py --sync && $PY scripts/analysis/doc_tables.py --verify && echo STEP_TABLES_OK
