...
Workers live in midian/methods/frameworks/workers/<fw>_worker.py and must run under the venv's python.
"""
...
def venv_python(env_name: str) -> str:
    ...
    if not os.path.exists(p):
        script = f"scripts/setup/fw_envs/{env_name.removeprefix('fw_')}.sh"
