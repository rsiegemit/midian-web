"""Aggregate rows -> paired statistics -> diagnostic figures -> pre-registered target check.
    ...
    python -m midian.analyze --grid smoke [--grids replay_scale,live_f1_n1000] [--out DIR]
...
The code lives in midian.analysis.{load,stats,legacy_figures,legacy_targets,report}; this module re-exports it.
"""
